...
namespace RestCsharp.Presentacion.PUNTO_DE_VENTA
{
    ...
    public partial class Punto_de_venta : Form
    {
        ...
        public static double totalpagarDIV;
        ...
        private void Crearpanelcobro()
        {
            ...
            panelContCobro.Size = new Size(786, 402);
        ...
        private void mostrarComproDefecto()
        {
        ...
        private void ObtenerImpuesto()
        {
            ...
            Trabajasconimp = dt.Rows[0][6].ToString();
            ...
            {
                Porcentajeimpu = Convert.ToDouble(dt.Rows[0][4]);
            }

            TipoImpuesto = (dt.Rows[0][3]).ToString();
            lblImpuesto1.Text = dt.Rows[0][11].ToString();
            lblImpuesto2.Text = dt.Rows[0][11].ToString();
            lbltipoimpuesto.Text = dt.Rows[0][11].ToString();
            Tiponotas = dt.Rows[0][10].ToString();
        }
        private void mostrarClienteEstandar()
        {
        ...
        private void MostrarDetalleVenta()
        {
            ...
            try
            {
                ...
                foreach (DataRow rdr in dt.Rows)
                {
                    ...
                    //*****************
                    lblimporte.Text = rdr["P_Unit"].ToString();
        ...
        private void sumar1(ref DataTable dt)
        {
            ...
            {
                Total += Convert.ToDouble(fila["Importe"]);
            }
            totalpagar = Total;
        ...
        public void B_Click(object sender, EventArgs e)
        {
            ...
            precioventa = Convert.ToDouble(separadas[0]);
            Preciocompra = Convert.ToDouble(separadas[1]);
            insertarVenta();
        }
